...
def main():
    ...
    print("🚀 Vibe Check - Running All Benchmarks")
    ...
    # Save summary
    summary_file = Path(
        f"benchmark_summary_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    )
    ...
    print("📊 Detailed results in: benchmark/results/")
