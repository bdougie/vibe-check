...
def test_single_task():
    ...
    try:
        ...
        stdout, stderr, returncode = runner._execute_cn_command(prompt, timeout=60)
...
def main():
    ...
    if passed == total:
        ...
        print(
            "   uv run python benchmark/batch_runner.py --task benchmark/tasks/easy/fix_typo.md --cn"
        )
        print()
        print("   # Run with specific models")
        print(
            "   uv run python benchmark/batch_runner.py --task benchmark/tasks/easy/fix_typo.md --models gpt-3.5-turbo,ollama/llama2 --cn"
        )
    else:
        print(
