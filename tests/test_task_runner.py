...
from benchmark.task_runner import get_git_diff_stats, run_benchmark_task, list_available_tasks
...
class TestTaskRunner:
    ...
    def test_list_available_tasks(self):
        ...
        expected_files = ["add_gitignore_entry.md", "fix_typo.md", 
                         "add_export_feature.md", "add_validation.md",
                         "implement_dashboard.md", "refactor_metrics.md"]
    ...
    def test_run_benchmark_task_success(self, mock_metrics_class, mock_git_stats, mock_input):
    ...
    @patch('benchmark.task_runner.get_git_diff_stats')
    @patch('benchmark.task_runner.BenchmarkMetrics')
    def test_run_benchmark_task_failure(self, mock_metrics_class, mock_git_stats, mock_input):
    ...
    @patch('benchmark.task_runner.get_git_diff_stats')
    @patch('benchmark.task_runner.BenchmarkMetrics')
    def test_run_benchmark_task_git_changes_rejected(self, mock_metrics_class, mock_git_stats, mock_input):
    ...
    @patch('benchmark.task_runner.get_git_diff_stats')
    @patch('benchmark.task_runner.BenchmarkMetrics')
    def test_run_benchmark_task_default_values(self, mock_metrics_class, mock_git_stats, mock_input):
